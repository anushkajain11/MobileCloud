...
$config['mongo_db']['default']['hostname'] = 'ds045143-a0.mongolab.com';
$config['mongo_db']['default']['port'] = '45143';
$config['mongo_db']['default']['username'] = 'thenotifyerprod';
$config['mongo_db']['default']['password'] = 'proddbuser123';
$config['mongo_db']['default']['database'] = 'thenotifyerprod';*/

$config['mongo_db']['default']['no_auth'] = TRUE;
$config['mongo_db']['default']['hostname'] = '52.39.235.16';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'a';
$config['mongo_db']['default']['password'] = 'a';
$config['mongo_db']['default']['database'] = 'sensorcloud'; 
